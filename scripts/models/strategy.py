...
from scripts.constants.configs import DEFAULT_FILTER_BET, DEFAULT_COMBO_LIST
...
def summarize_sim_result(sim_result, params, thr_analysis):
    ...
    support = matches / int(params['test_size'])
...
def simulation(test_result, params, thr_analysis, plot=False):
    ...
    params = check_simulation_params(params)
    # thr = params['thr']
...
def strategy_stats(testset, pred, true,
    ...
    simulation_params = check_simulation_params(simulation_params)
